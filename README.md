...
> 最后更新：2026-07-22 01:08 (UTC+8) | [English](./README_EN.md) | 中文
...
| `gpt-5.3-codex-spark` | Codex专属 | 0.8x | $1.12 | $8.96 | 官转OpenAI | 8x | $11.20 | $89.60 | 8x |
...
| 模型 | 最低价分组 | 倍率 | 输入($/M) | 输出($/M) | 推荐分组 | 倍率 | 输入($/M) | 输出($/M) | 出入比 |
|------|-----------|------|-----------|-----------|---------|------|-----------|-----------|--------|
| `gemini-2.0-flash-lite` | 官转gemini | 3.6x | $0.97 | $3.89 | 官转Gemini | 6x | $1.62 | $6.48 | 4x |
