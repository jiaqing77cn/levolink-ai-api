...
> Last updated: 2026-07-28 09:51 (UTC+8) | [中文](./README.md) | [English](./README_EN.md) | 한국어 | [日本語](./README_JA.md) | [Español](./README_ES.md) | [Deutsch](./README_DE.md)
...
| | [Levolink AI](https://ai.levolink.com) | SiliconFlow | 기타 프록시 | 자체 구축 |
|--|-------------|-------------|---------------|------------|
| 모델 수 | **500+** | ~200 | ~100 | 수동 |
| 그룹 옵션 | **33개 그룹** | 없음 | 1-3개 | - |
| 중국 CDN | ✅ 다중 노드 | ✅ 단일 | ✅ | ❌ |
| 최소 충전 | **1위안** | 50위안 | 20위안 | - |
| 사용량 기반 결제 | ✅ | ✅ | ✅ | ❌ |
| Claude Code 지원 | ✅ | ✅ | ✅ | ❌ |
| OpenAI Compatible | ✅ | ✅ | ✅ | 어댑터 필요 |
| 가격 투명성 | ✅ 33개 그룹 | 단일 가격 | 단일 가격 | - |
| 세금계산서 | ✅ | ✅ | ❌ | - |
